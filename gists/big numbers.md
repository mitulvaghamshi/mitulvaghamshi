...
- Pronouncing numbers upto $1$ followed by $309$ zeros (reading order: bottom to
  top).
- Rest follows the similar pattern such as: $101-illion (100 * 10^{306})$,
  $102-illion (100 * 10^{309})$, and so on.
- The base value (100) can be replaced with (10) or (1) and pronounced
  respectively: $10 million$ and 1 million.

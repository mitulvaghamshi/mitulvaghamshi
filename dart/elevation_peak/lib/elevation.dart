import 'package:elevation/config.dart';
import 'package:elevation/peak.dart';
...
extension Problem1 on Elevation {
  Pair findLowestElevation(List<List<int>> data) {
...
extension Problem3 on Elevation {
  Pair findClosestPeaks(List<Peak> peaks) {
    late Pair<Peak> pair;
...
extension Problem4 on Elevation {
  Pair findMostCommonHeight(List<List<int>> data) {

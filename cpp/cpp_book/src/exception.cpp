...
DevideByZeroException::DevideByZeroException(const std::string message) : message{message} {};
DevideByZeroException::~DevideByZeroException() {}
std::string DevideByZeroException::get_message(void) const noexcept { return message; }

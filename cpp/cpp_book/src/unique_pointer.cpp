...
int main(void)
{
    ...
    auto me_foundation = new UniquePointer<const char>{std::move(who_foundation)};
...
inline UniquePointer<T> make_unique(Args... args) { return UniquePointer<T>{new T{args...}}; }

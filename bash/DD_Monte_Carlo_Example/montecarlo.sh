...
# This controls which ord() function to use.
#
...
# It finds the ord of a character using only the shell, tr, and sed.
# The variable ORDSTRING must be initialized prior to first use with
# a call to ord_init. This string is not modified.
ord() {
    local CH="$1"
    local STRING=""

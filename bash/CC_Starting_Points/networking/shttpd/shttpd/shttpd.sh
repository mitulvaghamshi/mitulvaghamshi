...
DISABLE_TESTS=true
sh "$SCRIPTDIR"/shttpd.conf # Load this FIRST
sh "$SCRIPTDIR"/shttpd_subs/binary_tree.sh
sh "$SCRIPTDIR"/shttpd_subs/parsers.sh
sh "$SCRIPTDIR"/shttpd_subs/handlers.sh
sh "$SCRIPTDIR"/shttpd_subs/cgi.sh
